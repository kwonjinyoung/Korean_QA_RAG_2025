...
# Qwen3-32B 4bit 양자화로 Loss 0.05 이하까지 훈련하기 위한 파라미터 (1 GPU)
uv run python train.py \
    ...
    --output_dir ./results/qwen3-32b-4bit-korean-qa-improved-3 \
...
echo "32B 모델 4bit 양자화 + 1 GPU 훈련으로 메모리 효율성이 개선되었습니다"
